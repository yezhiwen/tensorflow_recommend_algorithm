...
from layer import layers, common_layer
...
def model_fn(features, labels, mode, params):
    ...
    cross_layer_out = layers.DCN(layer_num=3)(sparse_embeddings)
    dnn_out = common_layer.get_nn_layers(sparse_embeddings, dims=[256, 64])

    logits = common_layer.get_nn_layers(tf.concat([cross_layer_out, dnn_out], axis=1), dims=[1])
